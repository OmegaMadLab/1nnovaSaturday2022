...
$registry = Get-AzContainerRegistry -ResourceGroupName "1nn0vaSaturday2022_Demo_BicepResources_RG"
...
$bicepConfig.moduleAliases.br.mypublicreg.registry = $registry.LoginServer
...
New-AzTemplateSpec -ResourceGroupName "1nn0vaSaturday2022_Demo_BicepResources_RG" `
                -Name "APP1" `
                -Version "v1.0" `
